...
void rst::rasterizer::draw(std::vector<Triangle *> &TriangleList)
{
    ...
    for (const auto &t : TriangleList)
    {
        ...
        // get the coords in the view space
...
static Eigen::Vector2f interpolate_r(float alpha, float beta, float gamma, const Eigen::Vector2f &vert1, const Eigen::Vector2f &vert2, const Eigen::Vector2f &vert3, const std::array<Eigen::Vector3f, 3> view_pos, float z_interpolate)
{
    return z_interpolate * (alpha * vert1 / view_pos[0].z() + beta * vert2 / view_pos[1].z() + gamma * vert3 / view_pos[2].z());
}

static Eigen::Vector3f interpolate_r(float alpha, float beta, float gamma, const Eigen::Vector3f &vert1, const Eigen::Vector3f &vert2, const Eigen::Vector3f &vert3, const std::array<Eigen::Vector3f, 3> view_pos, float z_interpolate)
{
    return z_interpolate * (alpha * vert1 / view_pos[0].z() + beta * vert2 / view_pos[1].z() + gamma * vert3 / view_pos[2].z());
}
